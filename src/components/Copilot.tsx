  ...
  return <>
    ...
    <aside className={`copilot ${open ? "open" : ""}`} aria-hidden={!open}>
      ...
      <div className="copilot-scroll">
        <div className="copilot-intro"><Sparkles size={18}/><strong>Good morning, {name}.</strong><p>I found three signals that can affect service level or working capital today.</p></div>
