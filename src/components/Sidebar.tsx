...
interface Props { page: Page; setPage: (page: Page) => void; open: boolean; setOpen: (v:boolean) => void; }

export function Sidebar({ page, setPage, open, setOpen }: Props) {
  return <>
    ...
    <aside className={`sidebar ${open ? "open" : ""}`}>
      ...
      <button className="workspace-card"><span className="workspace-avatar">KK</span><span><strong>K&K Aarnas</strong><small>Hyderabad · Main depot</small></span><span className="live-dot"/></button>
      <nav>
